namespace AonFreelancing.Models.DTOs.NoftificationDTOs
{
    public class TaskApprovalNotificationOutputDTO : NotificationOutputDTO
    {
        ...
        TaskApprovalNotificationOutputDTO(TaskApprovalNotification taskApprovalNotification) : base(taskApprovalNotification.Id, taskApprovalNotification.Title, taskApprovalNotification.Message, taskApprovalNotification.IsRead, taskApprovalNotification.CreatedAt)
        {
