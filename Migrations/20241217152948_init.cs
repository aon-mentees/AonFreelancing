        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Education_Freelancers_freelancerId",
                        column: x => x.freelancerId,
                        principalTable: "Freelancers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "ProfileVisitNotifications",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileVisitNotifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfileVisitNotifications_AspNetUsers_VisitorId",
                        column: x => x.VisitorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProfileVisitNotifications_Notifications_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmitBidNotification", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubmitBidNotification_Freelancers_FreelancerId",
                        column: x => x.FreelancerId,
                        principalTable: "Freelancers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SubmitBidNotification_Notifications_Id",
                        column: x => x.Id,
                        principalTable: "Notifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubmitBidNotification_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<long>(type: "bigint", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "to-do"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BidApprovalNotifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BidApprovalNotifications_AspNetUsers_ApproverId",
                        column: x => x.ApproverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BidApprovalNotifications_Bids_BidId",
                        column: x => x.BidId,
                        principalTable: "Bids",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BidApprovalNotifications_Notifications_Id",
                        column: x => x.Id,
                        principalTable: "Notifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "BidRejectionNotifications",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    ProjectId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BidRejectionNotifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BidRejectionNotifications_AspNetUsers_RejectorId",
                        column: x => x.RejectorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BidRejectionNotifications_Bids_BidId",
                        column: x => x.BidId,
                        principalTable: "Bids",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BidRejectionNotifications_Notifications_Id",
                        column: x => x.Id,
                        principalTable: "Notifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BidApprovalNotifications_ApproverId",
                table: "BidApprovalNotifications",
                column: "ApproverId");

            migrationBuilder.CreateIndex(
                name: "IX_BidApprovalNotifications_BidId",
                table: "BidApprovalNotifications",
                column: "BidId");

            migrationBuilder.CreateIndex(
                name: "IX_BidRejectionNotifications_BidId",
                table: "BidRejectionNotifications",
                column: "BidId");

            migrationBuilder.CreateIndex(
                name: "IX_BidRejectionNotifications_RejectorId",
                table: "BidRejectionNotifications",
                column: "RejectorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileVisitNotifications_VisitorId",
                table: "ProfileVisitNotifications",
                column: "VisitorId");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "SubmitBidNotification",
                column: "FreelancerId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmitBidNotification_ProjectId",
                table: "SubmitBidNotification",
                column: "ProjectId");
